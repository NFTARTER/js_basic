...
const closeBtn = document.querySelector('.close'); /* mBg.querySelector('.close') */
console.log(mNavOpen, mBg, closeBtn);

mNavOpen.addEventListener('click' ,function(){ mBgSH('block'); })
closeBtn.addEventListener('click' ,function(){ mBgSH('none'); })
...
//데스크탑 로그인/장바구니(login_cart > a*2) 복제해서 모바일 메뉴 위치(login_cart)
